...
def test_function():
    ...
    assert s.get_parameters() == [{'interface': None, 'name': 'x', 'value': None},
    ...
    assert s.get_parameters() == [{'interface': None, 'name': 'w', 'value': None},
    ...
    assert s.get_parameters() == [{'interface': ISequence, 'name': 'w', 'value': []},
                   {'interface': None, 'name': 'x', 'value': None},
                   {'interface': IInt, 'name': 'y', 'value': 0},
