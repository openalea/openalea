...
class PropertyGraph (IPropertyGraph,Graph):
	...
	def vertex_property (self, property_name) :
		try :
			...
			raise PropertyError("property %s is undefined on vertices" % property_name)
	...
	def edge_property (self, property_name) :
		try :
			...
			raise PropertyError("property %s is undefined on edges" % property_name)
	...
	def add_vertex_property (self, property_name) :
		if property_name in self._vertex_property :
			raise PropertyError("property %s is already defined on vertices" % property_name)
	...
	def add_edge_property (self, property_name) :
		if property_name in self._edge_property :
			raise PropertyError("property %s is already defined on edges" % property_name)
