...
class InvalidVertex(GraphError, KeyError): pass
class InvalidEdge(GraphError, KeyError): pass
class InvalidGraph(GraphError): pass
class InexistingVertex(GraphError): pass
...
class VertexListGraphConcept(GraphConcept):
  ...
  def __len__(self): return self.nb_vertices()
