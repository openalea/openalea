...
.. toctree::
    ...
    sconsx/user_index.rst
    sconsx/reference_index.rst
    
- A `PDF <../latex/sconsx.pdf>`_ version of |sconsx| documentation is available.

.. seealso::

   More documentation can be found on the
   `openalea <http://openalea.gforge.inria.fr/dokuwiki/doku.php?id=packages:compilation_installation:sconsx:sconsx>`__ wiki.
...
|sconsx| is released under a Cecill-C License. See `LICENSE.txt <../../LICENSE.txt>`_    
