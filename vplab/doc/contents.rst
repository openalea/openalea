...
- A `PDF <../latex/vplab.pdf>`_ version of |vplab| documentation is 
  available.

.. seealso::

   More documentation can be found on the
   `openalea <http://openalea.gforge.inria.fr/dokuwiki/doku.php?id=packages:openalea:vplab:vplab>`__ wiki.
