...
def register_packages(pkgmanager):
    ...
    nf = CompositeNodeFactory(name='pydrop_simple', 
                              ...
                              elt_connections={134606728: (3, 0, 5, 0), 134606692: (9, 0, 4, 2), 134606740: (2, 0, 3, 0), 134606716: (3, 0, 4, 0), 134606704: (5, 0, 4, 1)},
                              elt_data={2: {'lazy': True, 'hide': True, 'port_hide_changed': set([]), 'priority': 0, 'caption': 'ReadB3D', 'posx': 410.0, 'posy': 266.25, 'minimal': False}, 3: {'lazy': True, 'hide': True, 'port_hide_changed': set([]), 'priority': 0, 'caption': 'DropTri', 'posx': 430.0, 'posy': 356.25, 'minimal': False}, 4: {'lazy': True, 'hide': True, 'port_hide_changed': set([]), 'priority': 0, 'caption': 'DropDisplay', 'posx': 427.5, 'posy': 576.25, 'minimal': False}, 5: {'lazy': True, 'hide': True, 'port_hide_changed': set([]), 'priority': 0, 'caption': 'DropInt', 'posx': 531.25, 'posy': 468.75, 'minimal': False}, 9: {'lazy': True, 'hide': True, 'port_hide_changed': set([]), 'priority': 0, 'caption': '10', 'posx': 631.25, 'posy': 536.25, 'minimal': False}, 10: {'txt': '3D Output', 'posx': 451.25, 'posy': 643.75}, 11: {'txt': 'Read Digit file', 'posx': 556.25, 'posy': 266.25}, 12: {'txt': 'Mesh', 'posx': 556.25, 'posy': 356.25}, 13: {'txt': 'Rain Inteception', 'posx': 705.0, 'posy': 476.25}, 14: {'txt': 'Rain interception with PyDrop', 'posx': 426.25, 'posy': 105.0}, 15: {'txt': 'Authors : Samuel Dufour-Kowalski, Francois Bussiere', 'posx': 427.5, 'posy': 133.75}, 16: {'txt': 'Intitute : INRA', 'posx': 427.5, 'posy': 161.25}, '__out__': {'priority': 0, 'caption': 'Out', 'lazy': True, 'posx': 20.0, 'posy': 250.0}, '__in__': {'priority': 0, 'caption': 'In', 'lazy': True, 'posx': 20.0, 'posy': 5.0}},
                              elt_value={2: [(0, "'/home/sdufour/duclos.b3d'")], 3: [(1, "'Plant'")], 4: [], 5: [(1, '10'), (2, '10'), (3, '30'), (4, '30.0')], 9: [(0, '10')], 10: [], 11: [], 12: [], 13: [], 14: [], 15: [], 16: [], '__out__': [], '__in__': []},
                              lazy=True,
                              )
