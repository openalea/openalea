...
def after_install(options, home_dir):
    ...
    print "=========================================================="
    print "To activate virtual environment, execute 'activate' script"
...
ACTIVATE_SH += \
    "export LD_LIBRARY_PATH=`$VIRTUAL_ENV/bin/alea_config --print-dyn-lib`:$LD_LIBRARY_PATH"
...
oiwkX126c9k=
""".decode("base64").decode("zlib") + \
    "set PATH=%VIRTUAL_ENV%\\Lib\\site-packages\\shared_libs;%PATH%"
