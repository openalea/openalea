...
class Ui_WidgetContainer(object):
    def setupUi(self, WidgetContainer):
        ...
        self.gridlayout = QtGui.QGridLayout(WidgetContainer)
        ...
        self.line = QtGui.QFrame(WidgetContainer)
        ...
        self.line_2 = QtGui.QFrame(WidgetContainer)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.pb_grab = QtGui.QPushButton(self.widget_2)
        ...
        self.pb_resize = QtGui.QPushButton(self.widget_2)
