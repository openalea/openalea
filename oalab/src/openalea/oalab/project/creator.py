...
class CreateProjectWidget(QtGui.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        layout.addWidget(QtGui.QLabel("Fill this to create your project"), 0, 0)
        ...
        self.ok_btn = QtGui.QPushButton("Create Project")
    ...
    def ok_clicked(self):
        ...
        self.project = proj
        self.emit(QtCore.SIGNAL('ProjectOpened(PyQt_PyObject)'), proj)
        self.hide()
