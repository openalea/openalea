...
Sphinx_configuration is used only in the **./doc/conf.py** script



.. currentmodule:: openalea.misc.multisetup

:mod:`openalea.misc.multisetup` module
=======================================

Download the source file :download:`../../src/openalea/misc/multisetup.py`.
