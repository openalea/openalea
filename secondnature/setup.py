...
# * name is the full name (e.g., OpenAlea.SecondNature) whereas pkg_name is only 'secondnature'
...
if("win32" in sys.platform):
    install_requires = ["openalea.visualea"]
else:
    install_requires = ["openalea.visualea"]
...
setup(
    ...
    entry_points = {
        #'wralea' : ['secondnature = openalea.secondnature_wralea'],
        #'console_scripts': [
