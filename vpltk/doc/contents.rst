...
- A `PDF <../latex/vpltk.pdf>`_ version of |vpltk| documentation is 
  available.

.. seealso::

   More documentation can be found on the
   `openalea <http://openalea.gforge.inria.fr/dokuwiki/doku.php?id=packages:openalea:vpltk:vpltk>`__ wiki.
