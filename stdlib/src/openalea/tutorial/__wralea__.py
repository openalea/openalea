...
# This file has been generated at Fri Nov 14 11:26:16 2008
...
__all__ = ['TutOrder', 'Tut4', '_96398512', 'Fibonacci', 'Tut1', 'Tut3', 'Tut2', 'TutWhile']
...
_96398512 = CompositeNodeFactory(name='multi_file', 
                             description='', 
                             category='composite,tutorial',
                             doc='',
                             inputs=[],
...
Fibonacci = CompositeNodeFactory(name='Fibonacci', 
   ...
   16: ('openalea.flow control', 'annotation')},
                             elt_connections={  9794328: (6, 0, 7, 0),
   9794340: (5, 0, 8, 0),
   9794352: (7, 0, 8, 1),
   9794364: (2, 0, 7, 1),
   9794376: (10, 0, 8, 2),
...
Tut3 = CompositeNodeFactory(name='Tut3', 
   ...
   10: ('openalea.function operator', 'filter')},
                             elt_connections={  9794376: (5, 0, 10, 0),
   9794388: (2, 0, 10, 1),
   9794400: (7, 0, 6, 0),
   9794412: (8, 0, 6, 1),
   9794424: (7, 0, 4, 1),
...
Tut2 = CompositeNodeFactory(name='Tut2', 
   ...
   7: ('openalea.flow control', 'annotation')},
                             elt_connections={  9794424: (3, 0, 5, 0),
   9794436: (6, 0, 2, 1),
   9794448: (4, 0, 5, 1),
   9794460: (5, 0, 2, 0)},
                             elt_data={  2: {  'block': False,
