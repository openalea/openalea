...
# This file has been generated at Sun Feb  7 17:40:03 2010
...
__all__ = ['_160487180', '_160487692', '_160487244', '_173895372']



_160487180 = CompositeNodeFactory(name='Stand_Reconstruction',
                             description='',
                             category='Demo',
                             doc='',
                             inputs=[],
...
_160487692 = CompositeNodeFactory(name='Stand_Reconstruction_grp_2',
                             description='',
                             category='Unclassified',
                             doc='',
                             inputs=[  {  'interface': IStr, 'name': 'text(csv2objs)', 'value': ''},
   ...
   16: ('openalea.python method', 'len')},
                             elt_connections={  140707764: (4, 0, 11, 1),
   140707776: (4, 1, 11, 2),
   140707788: (16, 0, 4, 0),
   140707812: (9, 0, 16, 0),
   140707836: (9, 0, 11, 0),
   170896076: ('__in__', 1, 9, 1),
   170896156: ('__in__', 0, 9, 0),
   171049684: ('__in__', 2, 9, 2),
   171049884: ('__in__', 3, 11, 3),
   171050004: ('__in__', 4, 11, 4),
   171561044: ('__in__', 5, 4, 2),
   171563684: ('__in__', 6, 4, 1),
   171563724: (9, 1, '__out__', 0),
   171563764: (11, 0, '__out__', 1),
   171563804: (4, 0, '__out__', 2),
   171563844: (4, 1, '__out__', 3)},
         ...
         'minimal': False,
         'port_hide_changed': set(),
         'posx': 586.63036875760031,
         'posy': 511.68836660002404,
         'priority': 0,
   ...
   9: {  'block': False,
         ...
         'minimal': False,
         'port_hide_changed': set(),
         'posx': 465.59062835436038,
         'posy': 461.95991594571211,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   ...
   11: [(3, "'Position mapping (PM)'"), (4, '{}')],
   16: []},
                             elt_ad_hoc={  4: {  'position': [586.63036875760031, 511.68836660002404],
         'useUserColor': False,
         'userColor': None},
   9: {  'position': [465.59062835436038, 461.95991594571211],
         'useUserColor': False,
         'userColor': None},
   11: {  'position': [490.73888882709309, 569.50524150671004],
          'useUserColor': False,
          'userColor': None},
   16: {  'position': [565.71435978855027, 465.30890176857861],
          'useUserColor': False,
          'userColor': None}},
                             lazy=True,
                             )
...
_160487244 = DataFactory(name='stand_data.csv',
                    description='',
                    editors=None,
                    includes=None,
                    )
...
_173895372 = CompositeNodeFactory(name='Stand_Reconstruction_grp_3',
                             description='',
                             category='Unclassified',
                             doc='',
                             inputs=[  {  'interface': IStr, 'name': 'text(csv2objs)', 'value': ''},
   ...
   11: ('vplants.stand', 'Stand Positioner'),
   16: ('openalea.python method', 'len')},
                             elt_connections={  145577908: (4, 0, 11, 1),
   145577920: (4, 1, 11, 2),
   145577932: (16, 0, 4, 0),
   145577956: (9, 0, 16, 0),
   145577980: (9, 0, 11, 0),
   158824044: ('__in__', 0, 9, 0),
   172747468: ('__in__', 1, 9, 1),
   173253412: ('__in__', 2, 9, 2),
   173253612: ('__in__', 3, 11, 3),
   173253732: ('__in__', 4, 11, 4),
   173891052: ('__in__', 5, 4, 2),
   173891212: ('__in__', 6, 4, 1),
   175665316: (9, 1, '__out__', 0),
   175665356: (11, 0, '__out__', 1),
   175665396: (4, 0, '__out__', 2),
   175665436: (4, 1, '__out__', 3)},
                             elt_data={  4: {  'block': False,
         'caption': 'Random 2D',
         'hide': True,
         'is_in_error_state': False,
   ...
   9: {  'block': False,
         ...
         'minimal': False,
         'port_hide_changed': set(),
         'posx': 435.7524267701632,
         'posy': 447.24091052340077,
         'priority': 0,
         'use_user_color': False,
         'user_application': None,
         'user_color': None},
   ...
   11: [(3, "'Position mapping (PM)'"), (4, '{}')],
   16: []},
                             elt_ad_hoc={  4: {'position': [777.21323158004805, 475.30436551573848], 'userColor': None, 'useUserColor': False},
   9: {'position': [435.7524267701632, 447.24091052340077], 'userColor': None, 'useUserColor': False},
   11: {'position': [490.73888882709309, 569.50524150671004], 'userColor': None, 'useUserColor': False},
   16: {'position': [565.71435978855027, 465.30890176857861], 'userColor': None, 'useUserColor': False}},
                             lazy=True,
                             )
